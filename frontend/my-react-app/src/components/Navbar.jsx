...
/* ── animation variants ──────────────────────────────── */
const navVariants = {
  top:      { backgroundColor: 'rgba(255,255,255,0.0)', backdropFilter: 'blur(0px)',  boxShadow: 'none' },
  scrolled: { backgroundColor: 'rgba(255,255,255,0.97)', backdropFilter: 'blur(20px)', boxShadow: '0 4px 30px rgba(0,0,0,0.08)' },
};
